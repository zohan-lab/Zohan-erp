...
export function exportPurchaseInvoicePDF(
  ...
  exportStyledInvoicePDF({
    ...
    partyName: invoice.partyNameSnapshot || invoice.supplierNameSnapshot || supplier?.name || 'Unknown Supplier',
    partyAddress: invoice.billingAddressSnapshot || invoice.partyAddressSnapshot || supplier?.address,
    partyPhone: invoice.partyPhoneSnapshot || supplier?.phone,
    partyState: invoice.stateNameSnapshot || invoice.stateCodeSnapshot || supplier?.stateCode || supplier?.stateName || supplier?.state,
    partyGstin: invoice.partyGstinSnapshot || supplier?.gstin,
...
export function exportSalesInvoicePDF(
  ...
  exportStyledInvoicePDF({
    ...
    invoiceDate: invoice.invoiceDate,
    partyLabel: 'Bill To',
    partyName: invoice.partyNameSnapshot || invoice.customerNameSnapshot || customer?.name || 'Unknown Customer',
    partyAddress: invoice.billingAddressSnapshot || invoice.partyAddressSnapshot || customer?.address,
    partyPhone: invoice.partyPhoneSnapshot || customer?.phone,
    partyState: invoice.stateNameSnapshot || invoice.stateCodeSnapshot || customer?.stateCode || customer?.stateName || customer?.state,
    partyGstin: invoice.partyGstinSnapshot || customer?.gstin,
    businessName: options.businessName || 'SK TRADERS',
    state: options.state,
    phone: options.phone,
    items: invoice.items,
