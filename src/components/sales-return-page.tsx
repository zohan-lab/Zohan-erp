...
import { formatCurrency, formatMT, getFYMonths, getFYFromDate, calculateRateWithGst, calculateBasicRateFromInclusive, calculateInvoiceFinalAmount, calculateNoteTaxBreakdown } from '@/lib/calculations'
    ...
    setReturnItems(prev => prev.map((itemRow, idx) => {
      ...
      if (field === 'itemId') {
        ...
        if (selectedDef && selectedDef.salesPrice) {
          ...
          updated.basicRate = calculateBasicRateFromInclusive(selectedDef.salesPrice, itemGstPct)
        }
      }
